...
const Placeorder = () => {
  ...
  const {numberInputOnWheelPreventChange} = useContext(ShopContext)
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t' >
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px] '>
        ...
        <div className='flex gap-3 '>
          ...
          <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} type="number" onWheel={numberInputOnWheelPreventChange} className='border border-gray-300 rounded py-1.5 px-3.5 w-full [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ' placeholder='Zipcode'/>
        ...
        <input required onChange={onChangeHandler} name='phone' value={formData.phone} type="number" onWheel={numberInputOnWheelPreventChange} className='border border-gray-300 rounded py-1.5 px-3.5 w-full [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ' placeholder='Phone'/>
