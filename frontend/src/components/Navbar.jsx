  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <ul className="hidden sm:flex gap-5 text-sm text-gray-700">
        ...
        <NavLink to='https://hubadmin-panel.vercel.app' target="_blank" className="border px-5 text-xs py-1 rounded-full -mt-2">
        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 " >
            ...
            <div className="flex  flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded ">
              ...
              <p onClick={() => navigate('/orders')} className="cursor-pointer hover:text-black hover:z--2 ">Orders</p>
              <p onClick={logout} className="cursor-pointer hover:text-black hover:z--2">Logout</p>
            </div>
